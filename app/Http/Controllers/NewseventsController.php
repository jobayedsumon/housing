...
class NewseventsController extends Controller {
	...
	public $module = 'newsevents';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Newsevents();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'newsevents',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('newsevents');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('newsevents.public.view',$data);			
			}			
		} 
		else {
			...
			return view('newsevents.public.index',$data);	
		}
