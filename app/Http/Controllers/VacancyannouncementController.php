...
class VacancyannouncementController extends Controller {
	...
	public $module = 'vacancyannouncement';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Vacancyannouncement();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'vacancyannouncement',
	...
	public static function display(  )
	{
		...
		$model  = new Vacancyannouncement();
		$info = $model::makeInfo('vacancyannouncement');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('vacancyannouncement.public.view',$data);			
			}			
		} 
		else {
			...
			return view('vacancyannouncement.public.index',$data);	
		}
