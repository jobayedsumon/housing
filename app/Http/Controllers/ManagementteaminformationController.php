...
use App\Models\Managementteaminformation;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class ManagementteaminformationController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'managementteaminformation';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Managementteaminformation();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'managementteaminformation',
	...
	public static function display(  )
	{
		...
		$model  = new Managementteaminformation();
		$info = $model::makeInfo('managementteaminformation');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('managementteaminformation.public.view',$data);			
			}			
		} 
		else {
			...
			return view('managementteaminformation.public.index',$data);	
		}
