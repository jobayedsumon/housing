					...
					<select name='show_home_page' rows='5'   class='select2 '  >
						...
						<div class="image-preview preview-upload">
						 ...
						 >{{ $row['feature'] }}</textarea>
                            ...
                            <div class="form-group row  " >
                                <label for="Deposit Term and Amount" class=" control-label col-md-4 text-left"> Deposit Term and Amount </label>
                                <div class="col-md-6">
										  <textarea name='types_deposit' rows='5' id='editor' class='form-control form-control-sm editor '
                                          >{{ $row['types_deposit'] }}</textarea>
                                </div>
                                <div class="col-md-2">
