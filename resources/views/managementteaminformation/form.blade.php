...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'managementteaminformation?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="p-5">
		...
		<div class="row">
	<div class="col-md-12">
						<fieldset><legend> Management Team Information</legend>
				{!! Form::hidden('id', $row['id']) !!}					
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Representing" class=" control-label col-md-4 text-left"> Representing </label>
										<div class="col-md-6">
										  <input  type='text' name='representing' id='representing' value='{{ $row['representing'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("managementteaminformation/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
